...
while getopts ":qepskdhf:x:" opt; do
    case $opt in
...
function encrypt_data
{
	...
	;;
        ...
        tracking-qso4you-services*)
        $DST=/Backups/tracking-qso4you-services/
	;;

	URL-QSO4YOU-COM*)
	$DST=/Backups/url-qso4you-com/
	;;

	qso4you-com*)
	$DST=/Backups/www-qso4you-com/
	;;

	cloud-extranet-qso4you-services*)
	$DST=/Backups/cloud-extranet-qso4you-services/
	;;

	email-qso4you-services*)
	$DST=/Backups/email-qso4you-services/
	;;

	QSO4YOU-Services*)
	$DST=/Backups/qso4you-services/
	;;
...
function usage
{
    ...
    echo -e "David Sondermann - david.sondermann@qso4you.com\n"
    ...
    echo -e "\t-e            Encrypts the file before uploading it to Dropbox using OPENSSL with a AES256"
